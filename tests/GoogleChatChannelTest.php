...
use GoogleChatConnector\Tests\Fixtures\TestNotifiable;
use GoogleChatConnector\Tests\Fixtures\TestNotification;
...
class GoogleChatChannelTest extends TestCase
{
    ...
    public function test_it_rejects_sending_when_non_google_chat_message_supplied()
    {
        ...
        $this->expectException(CouldNotSendNotification::class);
        $this->expectExceptionMessage("Expected a message instance of type GoogleChatConnector\GoogleChatMessage - Actually received string");
